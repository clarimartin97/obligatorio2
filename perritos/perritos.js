...
let simba = new Perrito("img/perrito4.jpg","Simba", "Macho", "Galgo", "Parque Batlle", 3, "Simba ha sido objeto de abusos físicos y verbales la mayor parte de su vida. Con algunos perros, esto los hace acobardarse y retirarse; con otros, los hace reactivos. Simba ha elegido el último curso. Ha aprendido en el pasado que no puede confiar ni confiar en su gente. Le estamos enseñando que la vida puede ser diferente, pero es un proceso largo y lento. Simba es mucho mejor de lo que era, pero le queda mucho por hacer. Por favor, no solicite a Simba porque crea que necesita amor y abrazos. No. Necesita consistencia, rutina y, sobre todo, saber que hay reglas, que está bastante seguro contigo, que no levantarás la voz y gritarás y pegarás por lo que lo elogiaste la semana anterior", [vacuna1Simba, polivalenteCaninaSimba, antirrabicaSimba, polivalenteRabiaSimba], true, true);
